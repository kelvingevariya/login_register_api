        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!!(loginEmail && loginPassword)) return [3 /*break*/, 1];
                ...
                case 3:
                    ...
                    if (!isPassSame) {
                        ...
                        token = jwt.sign({ username: userExists.username, email: userExists.email, role: userExists.role }, process.env.secret_key, { expiresIn: "2h" });
                        cookieOption = {
